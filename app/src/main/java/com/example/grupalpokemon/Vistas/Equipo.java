...
public class Equipo extends Menu {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnguardar.setOnClickListener(v -> {
            ...
            Notificaciones.notificar(this, "Notificacion", "Registro Guardado");
        });

        btnmovs.setOnClickListener(v -> {
            if (comprobar(rb1, rb2, rb3, rb4, rb5, rb6, this, pkmn1, pkmn2, pkmn3, pkmn4, pkmn5, pkmn6)) {
                alerta1 = new AlertDialog.Builder(this).create();
    ...
    private void txtclicables(TextView txt, int ps) {
        ...
        txt.setOnClickListener(v -> {
            ...
            if (comprobirtxt(txt, "Pokemon1") || comprobirtxt(txt, "Pokemon4") ||
                    comprobirtxt(txt, "Pokemon5") || comprobirtxt(txt, "Pokemon3") ||
                    comprobirtxt(txt, "Pokemon6") || comprobirtxt(txt, "Pokemon2")) {
